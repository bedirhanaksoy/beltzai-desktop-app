...
MAIN_OUTPUT_DIR = Path("./bounding_box_images")
...
def process_images_and_create_yolo_labels(image_paths, output_dir, class_id=0):
    for image_path in image_paths:
        ...
        labeled_image_path = os.path.join(MAIN_OUTPUT_DIR, os.path.basename(image_path))
        cv2.imwrite(labeled_image_path, edges_dilated)
